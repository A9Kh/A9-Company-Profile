    ...
    return (
        <div className="p-4 h-72 md:h-72 lg:h-80 transform transition duration-500 hover:scale-100 hover:rotate-0 hover:-translate-y-4 ease-in-out">
            <div className="group w-full h-full relative rounded-md">
                <img src={image} alt="photos" className="shadow-xl border-2 border-black border-opacity-20 group-hover:border-black object-center rounded-md w-full h-full object-cover transition duration-500 ease-in-out group-hover:shadow-2xl" />
