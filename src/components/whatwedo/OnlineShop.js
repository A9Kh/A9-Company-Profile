    ...
    return (
        <div className="flex flex-col lg:flex-row">
            ...
            <div className="flex flex-col w-full mt-4 sm:mt-7 lg:w-6/12 lg:mt-10">
                ...
                <a href="https://www.a9kh.com/" target="_blank" rel="noreferrer" className="flex bg-primary-300 px-10 py-3 rounded-full items-center gap-5 text-white hover:bg-primary-200 self-center lg:self-start">{t("btn_visit_a9_shop")} <ImArrowRight /> </a>
            </div>
        </div>
    )
}
