  ...
  return (
    ...
    <div className="container mx-auto ">
      <div className="text-gray-700 font-sans subpixel-antialiased tracking-wide lg:m-auto m-8">
        <h1 className="m-8 lg:mt-16 sm:mt-12 lg:ml-20 sm:mx-4 text-3xl font-bold text-gray-900">
          What We Do
        </h1>
        <p className="mx-8 lg:my-16 sm:my-12 my-8 lg:mx-20 sm:mx-4 text-lg font-semibold text-left">
      ...
      <div className="m-8 lg:mx-16 sm:mx-4 ">
        <div className="flex flex-wrap flex-row lg:flex-col sm:flex-row jutify-center w-full text-gray-700 bg-gray-100 rounded-lg shadow-md tracking-wide lg:mb-32 mb-12">
          {/* first */}
          <div className="flex flex-wrap flex-row lg:flex-row sm:flex-col h-1/2 w-full p-4">
            <div class="flex-1 lg:h-screen h-full w-auto lg:w-1/2 sm:w-full lg:px-12 sm:px-8 lg:pt-16 sm:pt-12 lg:py-auto py-4">
              <img class="h-auto w-full shadow-md" src={photos} />
            </div>
            <div className="lg:flex-1 h-auto w-auto  lg:w-1/2 sm:w-full tracking-wide text-left lg:p-16 sm:p-12 mt-4">
              <h1 className="lg:my-8 sm:my-4 ml-4 text-3xl font-bold text-gray-900">
                A9 Online Shopping
              </h1>
              <p className="my-12 lg:text-lg sm:text-lg font-semibold lg:text-left sm:text-justify lg:mx-auto mx-4">
                We work every day to earn and keep customers’ trust. We do this
                through convenient services and the thousands of small and
                medium businesses that add significantly to our product
                selection.
              </p>
              <p className="my-12 lg:my-16 lg:text-lg sm:text-lg font-semibold lg:text-left sm:text-justify lg:mx-auto mx-4">
              ...
              <div className="flex flex-wrap lg:w-60 w-48 bg-primary-200 hover:opacity-70 rounded-full py-3 px-6 lg:mt-8 lg:text-lg text-sm lg:m-0 my-12">
          ...
          {/* second */}
          <div className="flex flex-wrap flex-row lg:flex-row sm:flex-col h-1/3 w-full my-8 lg:my-12 sm:my-8">
            <div className="h-full lg:w-1/2 w-full lg:py-8 py-4 lg:pl-12 lg:pr-4 px-4">
              <div className="my-4 lg:my-8 text-3xl font-bold text-gray-900">
                <h1>Delivery & Logistics</h1>
                <p className="my-4 lg:my-8 text-lg font-semibold text-left">
                ...
                <div className="my-4 lg:my-8 lg:mx-28 mx-4 text-xl font-bold text-gray-900 text-left">
                  <h1>- Delivery Time</h1>
                  <h1>- Delivery area</h1>
          ...
          {/* last */}
          <div className="flex flex-wrap flex-row lg:flex-row sm:flex-col-reverse h-1/3 w-full my-8 lg:my-12 sm:my-8">
            <div className="flex-1 h-full lg:w-1/2 w-full lg:py-8 py-4 lg:pl-12 lg:pr-1 px-4">
              <img className="h-full w-auto" src={photos2} />
            </div>
            <div className="h-full lg:w-1/3 w-full pb-20 py-4 lg:pr-12 mx-4">
              <ul className="my-4 text-lg font-semibold text-left">
                <li>
