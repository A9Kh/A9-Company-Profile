...
export const whatwedoPage = () => {
  ...
  return (
    ...
    <div className="container mx-auto ">
      <div className="text-gray-700 font-sans subpixel-antialiased tracking-wide p-8 ">
        <h1 className="lg:mt-16 sm:mt-12 lg:ml-16 sm:mx-4 lg:text-3xl sm:2xl font-bold text-gray-900">
          What We Do
        </h1>
        <p className="sm:my-16 lg:mx-16 sm:mx-4 lg:text-2xl sm:text-lg font-semibold text-justify">
      ...
      <div className="lg:mx-16 sm:mx-4 m-8f">
        <div className="flex flex-wrap lg:flex-col sm:flex-row jutify-center w-full text-gray-700 bg-gray-100 rounded-lg shadow-md tracking-wide subpixel-antialiased lg:mb-32 mb-12">
          ...
          <div className="flex flex-wrap lg:flex-row flex-col h-auto max-w-full">
            <div class="flex-1 h-screen lg:w-1/2 sm:w-full lg:px-12 sm:px-8 lg:pt-16 sm:pt-12">
              <img class="h-screen w-full shadow-md" src={photos} />
            </div>
            <div className="flex-1 h-auto lg:w-1/2 sm:w-full tracking-wide lg:p-16 sm:p-12 mt-4">
              <div className="flex flex-wrap justify-between">
                ...
                <div className="lg:h-auto">
                  <p className="my-4 lg:text-2xl sm:text-lg font-semibold lg:text-left sm:text-justify lg:mx-auto sm:mx-4">
                ...
                <div className="lg:h-auto ">
                  <p className="my-4 lg:text-2xl sm:text-lg font-semibold lg:text-left sm:text-justify lg:mx-auto sm:mx-4 mb-4">
